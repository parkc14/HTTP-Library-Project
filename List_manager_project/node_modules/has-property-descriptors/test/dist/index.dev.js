...
test('hasPropertyDescriptors', function (t) {
  t.equal(_typeof(hasPropertyDescriptors), 'function', 'is a function');
  t.equal(_typeof(hasPropertyDescriptors.hasArrayLengthDefineBug), 'function', '`hasArrayLengthDefineBug` property is a function');
  var yes = hasPropertyDescriptors();
  t.test('property descriptors', {
    skip: !yes
  }, function (st) {
    var o = {
      a: sentinel
    };
    st.deepEqual(Object.getOwnPropertyDescriptor(o, 'a'), {
      configurable: true,
      enumerable: true,
      value: sentinel,
      writable: true
